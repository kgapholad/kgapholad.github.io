...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Dashboard-Contact</div>
  ...
  <form method="GET" action="/form-submit" accept-charset="UTF-8">
   ...
   <!-- radio buttons -->
   <label for="status" id="" class="">Status</label></br>
   <input checked="checked" name="status" type="radio" value="enabled" id="status"> Enabled</br>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\larry\resources\views/contact.blade.php ENDPATH**/ ?>